...
<template>
  <aside class="sm:flex">
    <div
      class="sm:h-[100svh] sm:w-60 sm:flex sm:overflow-y-auto border-r border-zinc-200 bg-zinc-50 pt-2 sm:h-[100vh] sm:w-64 dark:border-zinc-700 dark:bg-zinc-900">
      <!-- Sidebar content -->
      <div
        ...
        <div class="h-full space-y-4 overflow-y-auto border-b border-zinc-300 px-2 py-4 dark:border-zinc-700">
          <button v-for="chat in sortedChats" @click="switchChat(chat.id!)" @keyup.delete="deleteChat(chat.id!)" :class="{
